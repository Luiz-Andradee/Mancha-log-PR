...
map.getView().fit([-6015755.625888, -2983436.273977, -5575073.289296, -2759112.319097], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Projeto Mancha PR</h2>';
        return titleElement;
    })(),
